...
class UserRole(models.Model):
    ...
    def clean(self):
        ...
        if self.granted_by and self.granted_by.tenant_id != self.user.tenant_id:
            raise ValidationError(
                'Granted by user must belong to the same tenant'
            )
    ...
    @classmethod
    def assign_role(cls, user, role, granted_by=None, granted_by_username=None, reason=None, expires_at=None):
        """
    ...
    @classmethod
    def assign_roles_batch(cls, user, roles, granted_by=None, granted_by_username=None, reason=None):
        """
    ...
    @classmethod
    def revoke_role(cls, user, role, revoked_by=None, revoked_by_username=None, reason=None):
        """
    ...
    @classmethod
    def revoke_roles_batch(cls, user, roles, revoked_by=None, revoked_by_username=None, reason=None):
        """
    ...
    def get_active_role_codes_for_user(cls, user):
        ...
        """
        return list(
            cls.get_active_roles_for_user(user).values_list('slug', flat=True)
        )
...
class UserRoleAuditLog(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                ...
                name='idx_user_role_audit_user_created'
            ),
            models.Index(
                fields=['action'],
                name='idx_user_role_audit_action'
            ),
        ]
    ...
    @classmethod
    def log_action(cls, tenant, user, role=None, action='ASSIGN', 
                   actor=None, actor_username=None, reason=None, 
