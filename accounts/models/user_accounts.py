...
class UserAccount(AbstractBaseUser):
    ...
    def enable_2fa(self, secret, token):
        ...
        self.save(update_fields=['two_fa_secret', 'two_fa_enabled', 'two_fa_backup_codes'])
    ...
    def change_password(self, raw_password):
        ...
        self.save(update_fields=['password', 'last_password_change', 'must_change_password'])
