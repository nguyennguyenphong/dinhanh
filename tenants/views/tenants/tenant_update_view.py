...
class TenantUpdateView(LoginRequiredMixin, View):
    ...
    def patch(self, request, pk: uuid.UUID):
        ...
        if form.is_valid():
            ...
            serializer = TenantUpdateSerializer(data=cleaned_data, context={'tenant_id': tenant_model.id})
            ...
            if serializer.is_valid():
                if logo_file:
                    try:
                        ...
                        return render(request, "pages/update.html", {"form": form, "object": tenant_model})
                else:
        ...
        return render(request, "pages/update.html", {"form": form, "object": form.instance})