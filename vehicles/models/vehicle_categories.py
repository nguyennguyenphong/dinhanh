...
from django.contrib.postgres.fields import (  # Production feature for PostgreSQL TEXT[]
    ArrayField,
)
...
class VehicleCategory(BaseModel):
    ...
    name = models.CharField(max_length=100, help_text="Display name of the category")
    ...
    def filter_by_amenity(cls, tenant_id, amenity_name):
        ...
        return cls.objects.filter(
            tenant_id=tenant_id, amenities__contains=[amenity_name]
        )
