    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Name of the task list", max_length=100),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("LOW", "Low - Can be done anytime"),
                            ("MEDIUM", "Medium - Regular priority"),
                            ("HIGH", "High - Important task"),
                            ("URGENT", "Urgent - Must be done immediately"),
                        ],
                        db_index=True,
                        default="MEDIUM",
        ...
        migrations.AddIndex(
            model_name="task",
            index=models.Index(
                fields=["entity_type", "entity_id"], name="idx_tasks_entity"
            ),
        ),
        migrations.AddIndex(
            model_name="task",
            index=models.Index(
                condition=models.Q(("status__in", ["TODO", "IN_PROGRESS", "REVIEW"])),
                fields=["status"],
        ...
        migrations.AddIndex(
            model_name="task",
            index=models.Index(
                fields=["due_date", "status"], name="idx_tasks_due_status"
            ),
        ),
        migrations.AddIndex(
            model_name="task",
            index=models.Index(
                fields=["tenant", "status"], name="idx_tasks_tenant_status"
            ),
        ),
