...
class TaskList(SafeDeleteModel):
    ...
    name = models.CharField(max_length=100, help_text="Name of the task list")
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["tenant"], name="idx_task_list_tenant"),
            # Index for finding task lists by branch
            models.Index(fields=["branch"], name="idx_task_list_branch"),
            # Index for finding task lists by creator
            models.Index(fields=["created_by"], name="idx_task_list_creator"),
        ]
    ...
    def add_task(
        self, title, description="", priority="normal", due_date=None, assigned_to=None
    ):
        """
        Add task to list
