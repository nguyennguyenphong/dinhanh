    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=['tenant', 'code'],
                name='uq_tenant_storage_unit_code'
            )
        ]
    ...
    def clean(self):
        ...
        if self.branch_id and self.tenant_id != self.branch.tenant_id:
            raise ValidationError({
                'branch': _('Cross-Tenant Data Leak Error: Target corporate branch assigned to this storage unit belongs to a different tenant.')
            })