...
urlpatterns = [
    ...
    path(
        ...
        name="notification_log_list_api",
    ),
    path(
        "api/v1/create/",
        NotificationCreateApiView.as_view(),
        name="notification_log_create",
    ),
    path(
        "api/v1/detail/<int:pk>/",
        NotificationDetailApiView.as_view(),
        name="notification_log_detail_api",
    ),
    path(
        "api/v1/trigger-templated/",
        NotificationTriggerTemplatedApiView.as_view(),
        name="notification_trigger_templated",
    ),
    path(
