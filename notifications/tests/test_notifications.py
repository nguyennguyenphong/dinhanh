...
class TestNotificationTemplateEntity:
    def test_entity_validates_email_requires_subject(self):
        ...
        with pytest.raises(ValueError, match="Compliance Error: EMAIL channel blueprints require a subject line."):
            entity.validate()
    ...
    def test_entity_validates_variables_match_body(self):
        ...
        with pytest.raises(ValueError, match="Variable '\{age\}' detected in body but not listed in variables"):
            entity.validate()
