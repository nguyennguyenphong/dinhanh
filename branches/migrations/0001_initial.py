...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Display name of the branch", max_length=255
                    ),
                ),
                (
                    "address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("CREATE", "Create - Branch created"),
                            ("UPDATE", "Update - Branch modified"),
                            ("DELETE", "Delete - Branch deleted"),
                            ("ACTIVATE", "Activate - Branch activated"),
                            ("DEACTIVATE", "Deactivate - Branch deactivated"),
                        ],
                        db_index=True,
            ...
            options={
                "verbose_name": "Branch Audit Log",
                "verbose_name_plural": "Branch Audit Logs",
        ...
        migrations.AddIndex(
            model_name="branch",
            index=models.Index(fields=["manager_id"], name="idx_branch_manager"),
        ),
        migrations.AddIndex(
            model_name="branch",
            index=models.Index(fields=["timezone"], name="idx_branch_timezone"),
        ),
