...
class BranchAuditLog(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name='idx_branch_audit_tenant_created'
            ),
            models.Index(
                fields=['branch', 'created_at'],
                name='idx_branch_audit_branch_created'
            ),
        ]
    ...
    @classmethod
    def log_action(cls, tenant, branch, action, actor=None, 
                  actor_username=None, old_values=None, 
                  new_values=None, reason=None):
        """
        Log a branch action
