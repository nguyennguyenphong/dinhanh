...
class FeatureFlagAuditLog(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name='idx_feature_audit_tenant_created'
            ),
            models.Index(
                fields=['flag', 'created_at'],
                name='idx_feature_audit_flag_created'
            ),
        ]
    ...
    @classmethod
    def log_action(cls, tenant, flag, action, actor=None,
                  old_values=None, new_values=None, reason=None):
        """
