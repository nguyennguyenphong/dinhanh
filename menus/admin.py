...
@admin.register(MenuItemRole)
class MenuItemRoleAdmin(admin.ModelAdmin):
    list_display = ("menu_item", "role", "created_at")
    raw_id_fields = ("menu_item", "role")
    ordering = ("menu_item", "role")


@admin.register(MenuAuditLog)
...
@admin.register(MenuItemRoleAuditLog)
