...
class MenuGroupFilterForm(TailwindFormMixin, forms.Form):
    """
    This form is used to handle search data and advanced filters for the Menu Group list.
    It inherits TailwindFormMixin to automatically map the CSS interface synchronously.
    """

    search_menu_group = forms.CharField(required=False, widget=forms.TextInput())
