...
class Attendance(models.Model):
    ...
    def execute_admin_override(self, supervisor_user, target_status, audit_notes):
        ...
        self.notes = f"[Adjusted by Admin]: {audit_notes}" if self.notes is None else f"{self.notes} | [Adjusted]: {audit_notes}"
    ...
    def get_monthly_roster_by_employee(cls, employee_id, year, month):
        ...
        ).select_related('shift_type', 'approved_by').order_by('work_date')