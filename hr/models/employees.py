...
class Employee(BaseModel):
    ...
    full_name = models.CharField(
        max_length=255, help_text="Official full legal name of the employee"
    )
    ...
    phone = models.CharField(
        ...
        blank=True,
        validators=[
            RegexValidator(regex=r"^\+?[0-9\s.\-]+$", message="Invalid phone format")
        ],
    ...
    date_of_birth = models.DateField(
        null=True, blank=True, help_text="Official birth record calendar date"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["license_expiry"], name="idx_emp_license_compliance"),
        ]
    ...
    def get_available_drivers_by_branch(cls, branch_id):
        ...
        return cls.objects.filter(
            branch_id=branch_id, position="DRIVER", is_active=True
        ).order_by("full_name")
